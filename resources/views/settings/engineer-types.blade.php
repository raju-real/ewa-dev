                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        ...
                        <form action="{{ route("engineer-types.store") }}" method="POST" class="needs-validation" novalidate>
                            @csrf
                                ...
                                @foreach($results as $data)
                                    <tr>
                                        ...
                                        <td>
                                              ...
                                              <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                  <div class="modal-header">
                                                    ...
                                                    <form action="{{ route("engineer-types.update",$data->id) }}" method="POST" class="needs-validation" novalidate>
                                                        @csrf
                                                        @method('PUT')
                                                      <div class="modal-body">
                                                          <div class="form-group">
                                            ...
                                            <a href="javascript:void(0)" data-id="{{ 'delete-engineer-type-'.$data->id }}" class="delete-data btn btn-danger btn-xs btn-icon-text" >
                                                <form id="delete-engineer-type-{{ $data->id }}" action="{{ route('engineer-types.destroy',$data->id) }}"  method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
