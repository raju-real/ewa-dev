        ...
        <div class="col-12 grid-margin">
            ...
            <div class="profile-header">
                <div class="cover">
                    ...
                    <figure>
                        <img src="{{ Auth::user()->cover_photo != Null ? asset(Auth::user()->cover_photo) : 'https://via.placeholder.com/1148x272' }}" class="img-fluid" alt="profile cover">
                    </figure>
                    <div class="cover-body d-flex justify-content-between align-items-center">
                        <div>
                            <img class="profile-pic" src="{{ asset(Auth::user()->image ?? 'assets/images/avatar.jpg') }}" alt="profile">
                ...
                <div class="header-links">
                    <ul class="links d-flex align-items-center mt-3 mt-md-0">
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            ...
                            <a class="pt-1px d-none d-md-block" href="#">Members <span class="text-muted tx-12">{{ $members->count() ?? 0 }}</span></a>
                        </li>
                        <li class="header-link-item ml-3 pl-3 border-left d-flex align-items-center">
                            <i class="mr-1 icon-md" data-feather="book-open"></i>
                            <a class="pt-1px d-none d-md-block" href="#">Posts <span class="text-muted tx-12">{{ $members->count() ?? 0 }}</span></a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <form action="" method="POST">
                                ...
                                <div class="form-group">
                                    <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="What's on your mind ?"></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="file" name="attachment[]" accept="image/*,.pdf" multiple class="form-control">
                                </div>
                                <div class="form-group">
